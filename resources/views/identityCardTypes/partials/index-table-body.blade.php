...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('identity-card-types.show', $record->id)}}"
            ...
            @if(auth()->user()->can('identity-card-types.edit'))
                ...
                <a  href="{{route('identity-card-types.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('identity-card-types.destroy'))
                ...
                {!! Form::open(['route' => ['identity-card-types.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
