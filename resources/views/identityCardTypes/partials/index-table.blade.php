...
{!! Form::open(['route' => 'identity-card-types.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('identityCardTypes.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('identityCardTypes.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('identityCardTypes.partials.index-table-body')
        </tbody>
    </table>
</div>
