...
{{-- page title --}}
@section('title') {{trans('identityCardType.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('identityCardTypes.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('identityCardTypes.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('identityCardTypes.partials.index-table')
