...
{{-- page title --}}
@section('title') {{trans('employeeTaxpayerType.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('employeeTaxpayerTypes.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('employeeTaxpayerTypes.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('employeeTaxpayerTypes.partials.index-table')
