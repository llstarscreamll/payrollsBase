...
{!! Form::open(['route' => 'employee-taxpayer-types.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('employeeTaxpayerTypes.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('employeeTaxpayerTypes.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('employeeTaxpayerTypes.partials.index-table-body')
        </tbody>
    </table>
</div>
