...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('employee-taxpayer-types.show', $record->id)}}"
            ...
            @if(auth()->user()->can('employee-taxpayer-types.edit'))
                ...
                <a  href="{{route('employee-taxpayer-types.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('employee-taxpayer-types.destroy'))
                ...
                {!! Form::open(['route' => ['employee-taxpayer-types.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
