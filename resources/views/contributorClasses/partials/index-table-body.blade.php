...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('contributor-classes.show', $record->id)}}"
            ...
            @if(auth()->user()->can('contributor-classes.edit'))
                ...
                <a  href="{{route('contributor-classes.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('contributor-classes.destroy'))
                ...
                {!! Form::open(['route' => ['contributor-classes.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
