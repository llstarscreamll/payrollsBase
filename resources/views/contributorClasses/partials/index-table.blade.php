...
{!! Form::open(['route' => 'contributor-classes.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('contributorClasses.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('contributorClasses.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('contributorClasses.partials.index-table-body')
        </tbody>
    </table>
</div>
