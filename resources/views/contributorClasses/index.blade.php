...
{{-- page title --}}
@section('title') {{trans('contributorClass.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('contributorClasses.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('contributorClasses.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('contributorClasses.partials.index-table')
