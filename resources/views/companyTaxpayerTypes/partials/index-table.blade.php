...
{!! Form::open(['route' => 'company-taxpayer-types.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('companyTaxpayerTypes.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('companyTaxpayerTypes.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('companyTaxpayerTypes.partials.index-table-body')
        </tbody>
    </table>
</div>
