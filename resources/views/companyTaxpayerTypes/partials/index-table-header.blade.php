...
<tr class="header-row">
    ...
    <th class="id">
        {!! UISearch::sortLink('company-taxpayer-types.index', trans('companyTaxpayerType.table-columns.id'), 'id') !!}
    </th>
    @endif
    @if(in_array('name', $selectedTableColumns))
    <th class="name">
        {!! UISearch::sortLink('company-taxpayer-types.index', trans('companyTaxpayerType.table-columns.name'), 'name') !!}
    </th>
    @endif
    @if(in_array('short_name', $selectedTableColumns))
    <th class="short_name">
        {!! UISearch::sortLink('company-taxpayer-types.index', trans('companyTaxpayerType.table-columns.short_name'), 'short_name') !!}
    </th>
    @endif
    @if(in_array('created_at', $selectedTableColumns))
    <th class="created_at">
        {!! UISearch::sortLink('company-taxpayer-types.index', trans('companyTaxpayerType.table-columns.created_at'), 'created_at') !!}
    </th>
    @endif
    @if(in_array('updated_at', $selectedTableColumns))
    <th class="updated_at">
        {!! UISearch::sortLink('company-taxpayer-types.index', trans('companyTaxpayerType.table-columns.updated_at'), 'updated_at') !!}
    </th>
    @endif
