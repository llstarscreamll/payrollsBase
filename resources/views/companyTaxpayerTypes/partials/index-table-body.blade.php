...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('company-taxpayer-types.show', $record->id)}}"
            ...
            @if(auth()->user()->can('company-taxpayer-types.edit'))
                ...
                <a  href="{{route('company-taxpayer-types.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('company-taxpayer-types.destroy'))
                ...
                {!! Form::open(['route' => ['company-taxpayer-types.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
