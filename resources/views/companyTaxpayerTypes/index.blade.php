...
{{-- page title --}}
@section('title') {{trans('companyTaxpayerType.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('companyTaxpayerTypes.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('companyTaxpayerTypes.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('companyTaxpayerTypes.partials.index-table')
