...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('legal-person-natures.show', $record->id)}}"
            ...
            @if(auth()->user()->can('legal-person-natures.edit'))
                ...
                <a  href="{{route('legal-person-natures.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('legal-person-natures.destroy'))
                ...
                {!! Form::open(['route' => ['legal-person-natures.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
