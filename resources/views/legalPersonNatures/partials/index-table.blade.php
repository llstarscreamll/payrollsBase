...
{!! Form::open(['route' => 'legal-person-natures.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('legalPersonNatures.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('legalPersonNatures.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('legalPersonNatures.partials.index-table-body')
        </tbody>
    </table>
</div>
