...
{{-- page title --}}
@section('title') {{trans('legalPersonNature.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('legalPersonNatures.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('legalPersonNatures.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('legalPersonNatures.partials.index-table')
