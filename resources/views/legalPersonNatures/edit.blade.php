...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('legalPersonNature.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('legalPersonNatures.partials.heading', ['small_title' => trans('core::shared.views.edit')])
        ...
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {!! Form::model(
                    $legalPersonNature,
                    [
                        'route' => ['legal-person-natures.update', $legalPersonNature->id],
                        'method' => 'PUT',
                        'name' => 'edit-legal-person-natures-form'
                    ]
                ) !!}
