...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('municipalities.show', $record->id)}}"
            ...
            @if(auth()->user()->can('municipalities.edit'))
                ...
                <a  href="{{route('municipalities.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('municipalities.destroy'))
                ...
                {!! Form::open(['route' => ['municipalities.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
