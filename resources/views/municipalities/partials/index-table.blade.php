...
{!! Form::open(['route' => 'municipalities.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('municipalities.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('municipalities.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('municipalities.partials.index-table-body')
        </tbody>
    </table>
</div>
