...
<tr class="header-row">
    ...
    <th class="id">
        {!! UISearch::sortLink('municipalities.index', trans('municipality.table-columns.id'), 'id') !!}
    </th>
    @endif
    @if(in_array('department_id', $selectedTableColumns))
    <th class="department_id">
        {!! UISearch::sortLink('municipalities.index', trans('municipality.table-columns.department_id'), 'department_id') !!}
    </th>
    @endif
    @if(in_array('code', $selectedTableColumns))
    <th class="code">
        {!! UISearch::sortLink('municipalities.index', trans('municipality.table-columns.code'), 'code') !!}
    </th>
    @endif
    @if(in_array('name', $selectedTableColumns))
    <th class="name">
        {!! UISearch::sortLink('municipalities.index', trans('municipality.table-columns.name'), 'name') !!}
    </th>
    @endif
