...
{{-- page title --}}
@section('title') {{trans('municipality.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('municipalities.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('municipalities.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('municipalities.partials.index-table')
