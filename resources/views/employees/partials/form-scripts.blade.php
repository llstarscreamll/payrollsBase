...
<script type="text/javascript">
    ...
    $('input[name=admitted_at]').datetimepicker({
        locale: '{{ Lang::locale() }}',
        format: 'YYYY-MM-DD'
    });
    $('input[name=egressed_at]').datetimepicker({
        locale: '{{ Lang::locale() }}',
        format: 'YYYY-MM-DD'
    });
    ...
    initBootBoxComponent(
        '{{ trans('employee.index.modal-default-title') }}',
        '{{ trans('employee.index.modal-default-btn-confirmation') }}',
        'btn-primary',
