...
{!! Form::open(['route' => 'employees.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('employees.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('employees.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('employees.partials.index-table-body')
        </tbody>
    </table>
</div>
