...
{{-- page title --}}
@section('title') {{ trans('employee.index-create-btn') }} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('employees.partials.heading', ['small_title' => trans('core::shared.views.create')])
