...
{{-- page title --}}
@section('title') {{trans('department.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('departments.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('departments.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('departments.partials.index-table')
