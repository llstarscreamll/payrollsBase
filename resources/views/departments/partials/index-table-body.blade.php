...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('departments.show', $record->id)}}"
            ...
            @if(auth()->user()->can('departments.edit'))
                ...
                <a  href="{{route('departments.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('departments.destroy'))
                ...
                {!! Form::open(['route' => ['departments.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
