...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('department.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('departments.partials.heading', ['small_title' => trans('core::shared.views.edit')])
