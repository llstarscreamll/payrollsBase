...
{{-- page title --}}
@section('title') {{ trans('payrollType.index-create-btn') }} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('payrollTypes.partials.heading', ['small_title' => trans('core::shared.views.create')])
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {!! Form::open([
                    'route' => 'payroll-types.store',
                    'method' => 'POST',
                    'name' => 'create-payroll-types-form'
                ]) !!}
