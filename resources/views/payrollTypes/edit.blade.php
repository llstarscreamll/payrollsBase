...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('payrollType.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('payrollTypes.partials.heading', ['small_title' => trans('core::shared.views.edit')])
        ...
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {!! Form::model(
                    $payrollType,
                    [
                        'route' => ['payroll-types.update', $payrollType->id],
                        'method' => 'PUT',
                        'name' => 'edit-payroll-types-form'
                    ]
                ) !!}
