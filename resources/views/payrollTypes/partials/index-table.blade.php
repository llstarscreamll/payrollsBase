...
{!! Form::open(['route' => 'payroll-types.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('payrollTypes.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('payrollTypes.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('payrollTypes.partials.index-table-body')
        </tbody>
    </table>
</div>
