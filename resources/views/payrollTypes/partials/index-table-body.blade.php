...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('payroll-types.show', $record->id)}}"
            ...
            @if(auth()->user()->can('payroll-types.edit'))
                ...
                <a  href="{{route('payroll-types.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('payroll-types.destroy'))
                ...
                {!! Form::open(['route' => ['payroll-types.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
