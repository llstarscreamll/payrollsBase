...
{{-- page title --}}
@section('title') {{trans('pilaPaymentOperator.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('pilaPaymentOperators.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('pilaPaymentOperators.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('pilaPaymentOperators.partials.index-table')
