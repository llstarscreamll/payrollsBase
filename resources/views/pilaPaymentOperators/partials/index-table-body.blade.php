...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('pila-payment-operators.show', $record->id)}}"
            ...
            @if(auth()->user()->can('pila-payment-operators.edit'))
                ...
                <a  href="{{route('pila-payment-operators.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('pila-payment-operators.destroy'))
                ...
                {!! Form::open(['route' => ['pila-payment-operators.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
