...
<div class='form-group col-sm-6 {{ $errors->has('name') ? 'has-error' : null }}'>
	{!! Form::label('name', trans('pilaPaymentOperator.form-labels.name')) !!}
...
<div class='form-group col-sm-6 {{ $errors->has('short_name') ? 'has-error' : null }}'>
	{!! Form::label('short_name', trans('pilaPaymentOperator.form-labels.short_name')) !!}
...
<div class='form-group col-sm-6 {{ $errors->has('phone') ? 'has-error' : null }}'>
	{!! Form::label('phone', trans('pilaPaymentOperator.form-labels.phone')) !!}
...
<div class='form-group col-sm-6 {{ $errors->has('email') ? 'has-error' : null }}'>
	{!! Form::label('email', trans('pilaPaymentOperator.form-labels.email')) !!}
...
<div class='form-group col-sm-6 {{ $errors->has('website') ? 'has-error' : null }}'>
	{!! Form::label('website', trans('pilaPaymentOperator.form-labels.website')) !!}
	{!! Form::input('text', 'website', null, ['class' => 'form-control', isset($show) ? 'disabled' : null]) !!}
