...
{!! Form::open(['route' => 'pila-payment-operators.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('pilaPaymentOperators.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('pilaPaymentOperators.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('pilaPaymentOperators.partials.index-table-body')
        </tbody>
    </table>
</div>
