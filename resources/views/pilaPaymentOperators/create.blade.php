...
{{-- page title --}}
@section('title') {{ trans('pilaPaymentOperator.index-create-btn') }} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('pilaPaymentOperators.partials.heading', ['small_title' => trans('core::shared.views.create')])
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {!! Form::open([
                    'route' => 'pila-payment-operators.store',
                    'method' => 'POST',
                    'name' => 'create-pila-payment-operators-form'
                ]) !!}
