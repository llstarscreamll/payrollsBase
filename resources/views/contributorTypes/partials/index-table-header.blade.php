...
<tr class="header-row">
    ...
    <th class="id">
        {!! UISearch::sortLink('contributor-types.index', trans('contributorType.table-columns.id'), 'id') !!}
    </th>
    @endif
    @if(in_array('name', $selectedTableColumns))
    <th class="name">
        {!! UISearch::sortLink('contributor-types.index', trans('contributorType.table-columns.name'), 'name') !!}
    </th>
    @endif
    @if(in_array('short_name', $selectedTableColumns))
    <th class="short_name">
        {!! UISearch::sortLink('contributor-types.index', trans('contributorType.table-columns.short_name'), 'short_name') !!}
    </th>
    @endif
