...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('contributor-types.show', $record->id)}}"
            ...
            @if(auth()->user()->can('contributor-types.edit'))
                ...
                <a  href="{{route('contributor-types.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('contributor-types.destroy'))
                ...
                {!! Form::open(['route' => ['contributor-types.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
