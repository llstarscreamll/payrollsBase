...
{{-- page title --}}
@section('title') {{trans('contributorType.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('contributorTypes.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('contributorTypes.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('contributorTypes.partials.index-table')
