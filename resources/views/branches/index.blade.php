...
{{-- page title --}}
@section('title') {{trans('branch.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('branches.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('branches.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('branches.partials.index-table')
