...
{{-- page title --}}
@section('title') {{ trans('branch.index-create-btn') }} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('branches.partials.heading', ['small_title' => trans('core::shared.views.create')])
