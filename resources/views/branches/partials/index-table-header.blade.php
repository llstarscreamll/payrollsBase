...
<tr class="header-row">
    ...
    <th class="id">
        {!! UISearch::sortLink('branches.index', trans('branch.table-columns.id'), 'id') !!}
    </th>
    @endif
    @if(in_array('company_id', $selectedTableColumns))
    <th class="company_id">
        {!! UISearch::sortLink('branches.index', trans('branch.table-columns.company_id'), 'company_id') !!}
    </th>
    @endif
    @if(in_array('name', $selectedTableColumns))
    <th class="name">
        {!! UISearch::sortLink('branches.index', trans('branch.table-columns.name'), 'name') !!}
    </th>
    @endif
    @if(in_array('created_at', $selectedTableColumns))
    <th class="created_at">
        {!! UISearch::sortLink('branches.index', trans('branch.table-columns.created_at'), 'created_at') !!}
    </th>
    @endif
    @if(in_array('updated_at', $selectedTableColumns))
    <th class="updated_at">
        {!! UISearch::sortLink('branches.index', trans('branch.table-columns.updated_at'), 'updated_at') !!}
    </th>
    @endif
