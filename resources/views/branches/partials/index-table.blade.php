...
{!! Form::open(['route' => 'branches.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('branches.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('branches.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('branches.partials.index-table-body')
        </tbody>
    </table>
</div>
