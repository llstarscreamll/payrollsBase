...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('branches.show', $record->id)}}"
            ...
            @if(auth()->user()->can('branches.edit'))
                ...
                <a  href="{{route('branches.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('branches.destroy'))
                ...
                {!! Form::open(['route' => ['branches.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
