...
<div class="modal fade" id="create-form-modal" tabindex="-1" role="dialog" arialedby="{{trans('branch.index-create-form-modal-title')}}">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{{trans('branch.index-create-form-modal-title')}}</h4>
            </div>
