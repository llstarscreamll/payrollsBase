...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('branch.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('branches.partials.heading', ['small_title' => trans('core::shared.views.edit')])
