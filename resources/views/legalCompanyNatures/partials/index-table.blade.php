...
{!! Form::open(['route' => 'legal-company-natures.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('legalCompanyNatures.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('legalCompanyNatures.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('legalCompanyNatures.partials.index-table-body')
        </tbody>
    </table>
</div>
