...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('legal-company-natures.show', $record->id)}}"
            ...
            @if(auth()->user()->can('legal-company-natures.edit'))
                ...
                <a  href="{{route('legal-company-natures.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('legal-company-natures.destroy'))
                ...
                {!! Form::open(['route' => ['legal-company-natures.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
