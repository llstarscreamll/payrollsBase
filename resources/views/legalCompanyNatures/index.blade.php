...
{{-- page title --}}
@section('title') {{trans('legalCompanyNature.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('legalCompanyNatures.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('legalCompanyNatures.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('legalCompanyNatures.partials.index-table')
