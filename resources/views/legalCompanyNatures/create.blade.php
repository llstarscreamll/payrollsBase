...
{{-- page title --}}
@section('title') {{ trans('legalCompanyNature.index-create-btn') }} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('legalCompanyNatures.partials.heading', ['small_title' => trans('core::shared.views.create')])
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {!! Form::open([
                    'route' => 'legal-company-natures.store',
                    'method' => 'POST',
                    'name' => 'create-legal-company-natures-form'
                ]) !!}
