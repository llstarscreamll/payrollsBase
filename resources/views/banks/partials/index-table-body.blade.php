...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('banks.show', $record->id)}}"
            ...
            @if(auth()->user()->can('banks.edit'))
                ...
                <a  href="{{route('banks.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('banks.destroy'))
                ...
                {!! Form::open(['route' => ['banks.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
