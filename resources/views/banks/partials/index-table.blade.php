...
{!! Form::open(['route' => 'banks.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('banks.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('banks.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('banks.partials.index-table-body')
        </tbody>
    </table>
</div>
