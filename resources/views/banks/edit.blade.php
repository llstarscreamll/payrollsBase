...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('bank.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('banks.partials.heading', ['small_title' => trans('core::shared.views.edit')])
