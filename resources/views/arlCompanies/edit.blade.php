...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('arlCompany.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('arlCompanies.partials.heading', ['small_title' => trans('core::shared.views.edit')])
        ...
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {!! Form::model(
                    $arlCompany,
                    [
                        'route' => ['arl-companies.update', $arlCompany->id],
                        'method' => 'PUT',
                        'name' => 'edit-arl-companies-form'
                    ]
                ) !!}
