...
{{-- page title --}}
@section('title') {{trans('arlCompany.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('arlCompanies.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('arlCompanies.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('arlCompanies.partials.index-table')
