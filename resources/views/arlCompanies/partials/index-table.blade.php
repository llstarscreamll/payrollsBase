...
{!! Form::open(['route' => 'arl-companies.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('arlCompanies.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('arlCompanies.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('arlCompanies.partials.index-table-body')
        </tbody>
    </table>
</div>
