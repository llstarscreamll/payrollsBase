...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('arl-companies.show', $record->id)}}"
            ...
            @if(auth()->user()->can('arl-companies.edit'))
                ...
                <a  href="{{route('arl-companies.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('arl-companies.destroy'))
                ...
                {!! Form::open(['route' => ['arl-companies.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
