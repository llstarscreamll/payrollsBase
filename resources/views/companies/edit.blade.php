...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('company.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('companies.partials.heading', ['small_title' => trans('core::shared.views.edit')])
