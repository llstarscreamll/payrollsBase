...
{!! Form::open(['route' => 'companies.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('companies.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('companies.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('companies.partials.index-table-body')
        </tbody>
    </table>
</div>
