...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="company_taxpayer_type_id">
            {{ $record->companyTaxpayerType ? $record->companyTaxpayerType->name : '' }}
        </td>
        @endif
        ...
        <td class="legal_person_nature_id">
            {{ $record->legalPersonNature ? $record->legalPersonNature->name : '' }}
        </td>
        @endif
...
@empty
    ...
    <tr>
        <td class="empty-table" colspan="18">
