...
{!! Form::open(['route' => 'user-concepts.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('userConcepts.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('userConcepts.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('userConcepts.partials.index-table-body')
        </tbody>
    </table>
</div>
