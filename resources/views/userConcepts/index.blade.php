...
{{-- page title --}}
@section('title') {{trans('userConcept.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('userConcepts.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('userConcepts.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('userConcepts.partials.index-table')
