...
{{-- page title --}}
@section('title') {{trans('branchOffice.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('branchOffices.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('branchOffices.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('branchOffices.partials.index-table')
