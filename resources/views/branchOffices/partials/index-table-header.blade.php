...
<tr class="header-row">
    ...
    <th class="id">
        {!! UISearch::sortLink('branch-offices.index', trans('branchOffice.table-columns.id'), 'id') !!}
    </th>
    @endif
    @if(in_array('company_id', $selectedTableColumns))
    <th class="company_id">
        {!! UISearch::sortLink('branch-offices.index', trans('branchOffice.table-columns.company_id'), 'company_id') !!}
    </th>
    @endif
    @if(in_array('name', $selectedTableColumns))
    <th class="name">
        {!! UISearch::sortLink('branch-offices.index', trans('branchOffice.table-columns.name'), 'name') !!}
    </th>
    @endif
