...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('branch-offices.show', $record->id)}}"
            ...
            @if(auth()->user()->can('branch-offices.edit'))
                ...
                <a  href="{{route('branch-offices.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('branch-offices.destroy'))
                ...
                {!! Form::open(['route' => ['branch-offices.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
