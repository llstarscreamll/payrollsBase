...
<div class='form-group col-sm-6 {{ $errors->has('company_id') ? 'has-error' : null }}'>
	{!! Form::label('company_id', trans('branchOffice.form-labels.company_id')) !!}
	{!! Form::select(
		'company_id',
		$company_id_list,
...
<div class='form-group col-sm-6 {{ $errors->has('name') ? 'has-error' : null }}'>
	{!! Form::label('name', trans('branchOffice.form-labels.name')) !!}
