...
@forelse ( $records as $record )
    ...
    <td class="checkbox-column">
        ...
        <td class="actions-column">
            ...
            <a  href="{{route('employee-contributor-types.show', $record->id)}}"
            ...
            @if(auth()->user()->can('employee-contributor-types.edit'))
                ...
                <a  href="{{route('employee-contributor-types.edit', $record->id)}}"
            ...
            @if(auth()->user()->can('employee-contributor-types.destroy'))
                ...
                {!! Form::open(['route' => ['employee-contributor-types.destroy', $record->id], 'method' => 'DELETE', 'class' => 'form-inline display-inline']) !!}
