...
<div class="modal fade" id="create-form-modal" tabindex="-1" role="dialog" arialedby="{{trans('employeeContributorType.index-create-form-modal-title')}}">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">{{trans('employeeContributorType.index-create-form-modal-title')}}</h4>
            </div>

            <div class="modal-body">

                {!! Form::open(['route' => 'employee-contributor-types.store', 'method' => 'POST']) !!}
