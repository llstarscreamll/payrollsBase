...
{!! Form::open(['route' => 'employee-contributor-types.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('employeeContributorTypes.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('employeeContributorTypes.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('employeeContributorTypes.partials.index-table-body')
        </tbody>
    </table>
</div>
