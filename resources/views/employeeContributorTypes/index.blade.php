...
{{-- page title --}}
@section('title') {{trans('employeeContributorType.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('employeeContributorTypes.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('employeeContributorTypes.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('employeeContributorTypes.partials.index-table')
