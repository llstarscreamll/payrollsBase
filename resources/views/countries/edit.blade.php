...
{{-- page title --}}
@section('title') {{trans('core::shared.views.edit').trans('country.module.name-singular')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('countries.partials.heading', ['small_title' => trans('core::shared.views.edit')])
            ...
            <div class="ibox-content">
                ...
                {!! Form::model(
                    ...
                    [
                        ...
                        'method' => 'PUT',
                        'name' => 'edit-countries-form'
                    ]
                ) !!}

                    @include('countries.partials.form-fields')
