...
{{-- page title --}}
@section('title') {{trans('country.module.name')}} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('countries.partials.heading')
    ...
    <div class="row">
        <div class="col-xs-12 animated fadeInRight">
            ...
            <div class="ibox-content">
                ...
                {{-- botonera --}}
                @include('countries.partials.index-buttons')
                
                {{-- notificaciones --}}
                @include('core::partials.notifications')
                
                {{-- tabla de datos --}}
                @include('countries.partials.index-table')
