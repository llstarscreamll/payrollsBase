...
{{-- page title --}}
@section('title') {{ trans('country.index-create-btn') }} @endsection
{{-- /page title --}}
...
{{-- heading --}}
@include('countries.partials.heading', ['small_title' => trans('core::shared.views.create')])
