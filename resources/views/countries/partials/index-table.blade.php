...
{!! Form::open(['route' => 'countries.index', 'method' => 'GET', 'id' => 'searchForm']) !!}
{!! Form::close() !!}
...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            {{-- header de la tabla --}}
            @include('countries.partials.index-table-header')

            {{-- formulario de búsqueda --}}
            @include('countries.partials.index-table-search')
        </thead>

        <tbody>
            {{-- body de tabla --}}
            @include('countries.partials.index-table-body')
        </tbody>
    </table>
</div>
