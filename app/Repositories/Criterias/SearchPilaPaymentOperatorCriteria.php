...
/**
 * Class SearchPilaPaymentOperatorCriteria
 *
 * @author Johan Alvarez <llstarscreamll@hotmail.com>
 */
class SearchPilaPaymentOperatorCriteria implements CriteriaInterface
{
    /**
    ...
    /**
     * Crea nueva instancia de SearchPilaPaymentOperatorCriteria.
     *
     ...
     *
     * @param PilaPaymentOperator $model
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        $this->input->get('website') && $model->where('website', 'like', '%'.$this->input->get('website').'%');
