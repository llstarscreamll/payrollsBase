...
/**
 * Class SearchArlCompanyCriteria
 *
 * @author Johan Alvarez <llstarscreamll@hotmail.com>
 */
class SearchArlCompanyCriteria implements CriteriaInterface
{
    /**
    ...
    /**
     * Crea nueva instancia de SearchArlCompanyCriteria.
     *
