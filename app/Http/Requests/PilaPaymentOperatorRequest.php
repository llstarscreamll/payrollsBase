...
class PilaPaymentOperatorRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\PilaPaymentOperator
     */
    private $pilaPaymentOperator;
    ...
    private $routesAuthMap = [
        'pila-payment-operators.store' => 'pila-payment-operators.create',
        'pila-payment-operators.update' => 'pila-payment-operators.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'pilaPaymentOperator.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'pilaPaymentOperator.attributes';
