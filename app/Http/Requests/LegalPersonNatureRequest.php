...
class LegalPersonNatureRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\LegalPersonNature
     */
    private $legalPersonNature;
    ...
    private $routesAuthMap = [
        'legal-person-natures.store' => 'legal-person-natures.create',
        'legal-person-natures.update' => 'legal-person-natures.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'legalPersonNature.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'legalPersonNature.attributes';
