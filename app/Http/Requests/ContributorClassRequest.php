...
class ContributorClassRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\ContributorClass
     */
    private $contributorClass;
    ...
    private $routesAuthMap = [
        'contributor-classes.store' => 'contributor-classes.create',
        'contributor-classes.update' => 'contributor-classes.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'contributorClass.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'contributorClass.attributes';
