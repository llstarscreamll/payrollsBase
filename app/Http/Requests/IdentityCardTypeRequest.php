...
class IdentityCardTypeRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\IdentityCardType
     */
    ...
    private $routesAuthMap = [
        'identity-card-types.store' => 'identity-card-types.create',
        'identity-card-types.update' => 'identity-card-types.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'identityCardType.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'identityCardType.attributes';
