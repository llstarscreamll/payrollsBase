...
class LegalCompanyNatureRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\LegalCompanyNature
     */
    private $legalCompanyNature;
    ...
    private $routesAuthMap = [
        'legal-company-natures.store' => 'legal-company-natures.create',
        'legal-company-natures.update' => 'legal-company-natures.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'legalCompanyNature.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'legalCompanyNature.attributes';
