...
class CompanyTaxpayerTypeRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\CompanyTaxpayerType
     */
    private $companyTaxpayerType;
    ...
    private $routesAuthMap = [
        'company-taxpayer-types.store' => 'company-taxpayer-types.create',
        'company-taxpayer-types.update' => 'company-taxpayer-types.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'companyTaxpayerType.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'companyTaxpayerType.attributes';
