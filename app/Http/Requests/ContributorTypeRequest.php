...
class ContributorTypeRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\ContributorType
     */
    ...
    private $routesAuthMap = [
        'contributor-types.store' => 'contributor-types.create',
        'contributor-types.update' => 'contributor-types.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'contributorType.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'contributorType.attributes';
