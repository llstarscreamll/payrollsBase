...
class EmployeeContributorTypeRequest extends FormRequest
{
    use FormRequestBasicSetup;

    /**
     * @var App\Models\EmployeeContributorType
     */
    private $employeeContributorType;
    ...
    private $routesAuthMap = [
        'employee-contributor-types.store' => 'employee-contributor-types.create',
        'employee-contributor-types.update' => 'employee-contributor-types.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'employeeContributorType.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'employeeContributorType.attributes';
