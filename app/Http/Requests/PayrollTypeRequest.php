...
class PayrollTypeRequest extends FormRequest
{
    ...
    private $routesAuthMap = [
        'payroll-types.store' => 'payroll-types.create',
        'payroll-types.update' => 'payroll-types.edit',
    ];
     ...
     * @var string
     */
    private $messagesLangPath = 'payrollType.messages';
     ...
     * @var string
     */
    private $attributesLangPath = 'payrollType.attributes';
