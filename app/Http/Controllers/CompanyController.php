...
class CompanyController extends Controller
{
    ...
    {
        $data = $this->companyService->getIndexTableData($request);
        $data['records'] = $this->companyService->indexSearch($request);
    ...
    {
        $data = $this->companyService->getShowFormData($id);
    ...
    {
        $this->companyService->destroy($id, $request);
        return redirect()->route('companies.index');
    }
