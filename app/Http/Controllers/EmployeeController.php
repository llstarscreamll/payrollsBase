...
class EmployeeController extends Controller
{
    ...
    {
        $data = $this->employeeService->getIndexTableData($request);
        $data['records'] = $this->employeeService->indexSearch($request);
    ...
    {
        $data = $this->employeeService->getCreateFormData();
    ...
    {
        $data = $this->employeeService->getShowFormData($id);
    ...
    {
        $data = $this->employeeService->getEditFormData($id);
    ...
    {
        $this->employeeService->destroy($id, $request);
        return redirect()->route('employees.index');
    }
