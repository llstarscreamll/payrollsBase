...
use Page\Functional\ContributorClasses\Destroy as Page;
...
class DestroyCest
{
    ...
    public function deleteMany(FunctionalTester $I)
    {
        ...
        $contributorClasses = factory(ContributorClass::class, 10)->create();
        ...
        $I->submitForm('#deletemanyForm', [
            'id' => $contributorClasses->pluck('id')->toArray()
        ]);
        $I->dontSeeFormErrors();
