...
use Page\Functional\ContributorClasses\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveContributorClass($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$contributorClassData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$contributorClassData['id'].'/edit'));
        ...
        $I->seeRecord('contributor_classes', null_empty_fields($updateData));
    }
}