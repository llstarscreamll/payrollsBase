...
namespace ContributorClasses;

use FunctionalTester;
use App\Models\ContributorClass;
use llstarscreamll\Core\Models\Role;
use llstarscreamll\Core\Models\Permission;
use Page\Functional\ContributorClasses\Index as Page;
use Page\Functional\ContributorClasses\Destroy as DestroyPage;
use Page\Functional\ContributorClasses\Create as CreatePage;
use Page\Functional\ContributorClasses\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'contributor-classes.create',
            'contributor-classes.edit',
            'contributor-classes.destroy',
        ];
        ...
        $this->contributorClassId = Page::haveContributorClass($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->contributorClassId"));
        ...
        $I->amOnPage(Page::route("/$this->contributorClassId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
