...
use Page\Functional\Branches\Index as Page;
use Page\Functional\Branches\Destroy as DestroyPage;
use Page\Functional\Branches\Create as CreatePage;
use Page\Functional\Branches\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->branchId = Page::haveBranch($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->branchId"));
        ...
        $I->amOnPage(Page::route("/$this->branchId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
