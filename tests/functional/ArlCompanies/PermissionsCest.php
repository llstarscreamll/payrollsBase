...
namespace ArlCompanies;

use FunctionalTester;
use App\Models\ArlCompany;
use llstarscreamll\Core\Models\Role;
use llstarscreamll\Core\Models\Permission;
use Page\Functional\ArlCompanies\Index as Page;
use Page\Functional\ArlCompanies\Destroy as DestroyPage;
use Page\Functional\ArlCompanies\Create as CreatePage;
use Page\Functional\ArlCompanies\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'arl-companies.create',
            'arl-companies.edit',
            'arl-companies.destroy',
        ];
        ...
        $this->arlCompanyId = Page::haveArlCompany($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->arlCompanyId"));
        ...
        $I->amOnPage(Page::route("/$this->arlCompanyId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
