...
use Page\Functional\ArlCompanies\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveArlCompany($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$arlCompanyData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$arlCompanyData['id'].'/edit'));
        ...
        $I->seeRecord('arl_companies', null_empty_fields($updateData));
    }
}