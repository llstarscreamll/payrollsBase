...
use Page\Functional\BranchOffices\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveBranchOffice($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$branchOfficeData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$branchOfficeData['id'].'/edit'));
        ...
        $I->seeRecord('branch_offices', null_empty_fields($updateData));
    }
}