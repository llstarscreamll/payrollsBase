...
use Page\Functional\PilaPaymentOperators\Index as Page;
use Page\Functional\PilaPaymentOperators\Destroy as DestroyPage;
use Page\Functional\PilaPaymentOperators\Create as CreatePage;
use Page\Functional\PilaPaymentOperators\Edit as EditPage;
...
class PermissionsCest
{
     ...
     * @var  int
     */
    protected $pilaPaymentOperatorId;
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'pila-payment-operators.create',
            'pila-payment-operators.edit',
            'pila-payment-operators.destroy',
        ];
        ...
        $this->pilaPaymentOperatorId = Page::havePilaPaymentOperator($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->pilaPaymentOperatorId"));
        ...
        $I->amOnPage(Page::route("/$this->pilaPaymentOperatorId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
