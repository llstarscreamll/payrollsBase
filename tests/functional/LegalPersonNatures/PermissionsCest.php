...
namespace LegalPersonNatures;

use FunctionalTester;
use App\Models\LegalPersonNature;
use llstarscreamll\Core\Models\Role;
use llstarscreamll\Core\Models\Permission;
use Page\Functional\LegalPersonNatures\Index as Page;
use Page\Functional\LegalPersonNatures\Destroy as DestroyPage;
use Page\Functional\LegalPersonNatures\Create as CreatePage;
use Page\Functional\LegalPersonNatures\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'legal-person-natures.create',
            'legal-person-natures.edit',
            'legal-person-natures.destroy',
        ];
        ...
        $this->legalPersonNatureId = Page::haveLegalPersonNature($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->legalPersonNatureId"));
        ...
        $I->amOnPage(Page::route("/$this->legalPersonNatureId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
