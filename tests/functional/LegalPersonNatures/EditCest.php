...
use Page\Functional\LegalPersonNatures\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveLegalPersonNature($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$legalPersonNatureData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$legalPersonNatureData['id'].'/edit'));
        ...
        $I->seeRecord('legal_person_natures', null_empty_fields($updateData));
    }
}