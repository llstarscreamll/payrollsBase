...
use Page\Functional\LegalPersonNatures\Destroy as Page;
...
class DestroyCest
{
    ...
    public function deleteMany(FunctionalTester $I)
    {
        ...
        $legalPersonNatures = factory(LegalPersonNature::class, 10)->create();
        ...
        $I->submitForm('#deletemanyForm', [
            'id' => $legalPersonNatures->pluck('id')->toArray()
        ]);
        $I->dontSeeFormErrors();
