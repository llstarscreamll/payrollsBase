...
use Page\Functional\Departments\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$departmentData['id'].'/edit'));
        ...
        $I->seeRecord('departments', null_empty_fields($updateData));
    }
}