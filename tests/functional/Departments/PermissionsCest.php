...
use Page\Functional\Departments\Create as CreatePage;
use Page\Functional\Departments\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->departmentId = Page::haveDepartment($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->departmentId"));
        ...
        $I->amOnPage(Page::route("/$this->departmentId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
