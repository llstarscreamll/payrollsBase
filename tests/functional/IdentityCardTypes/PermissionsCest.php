...
use Page\Functional\IdentityCardTypes\Create as CreatePage;
use Page\Functional\IdentityCardTypes\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'identity-card-types.create',
            'identity-card-types.edit',
            'identity-card-types.destroy',
        ];
        ...
        $this->identityCardTypeId = Page::haveIdentityCardType($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->identityCardTypeId"));
        ...
        $I->amOnPage(Page::route("/$this->identityCardTypeId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
