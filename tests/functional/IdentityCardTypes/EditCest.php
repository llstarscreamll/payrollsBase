...
use Page\Functional\IdentityCardTypes\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$identityCardTypeData['id'].'/edit'));
        ...
        $I->seeRecord('identity_card_types', null_empty_fields($updateData));
    }
}