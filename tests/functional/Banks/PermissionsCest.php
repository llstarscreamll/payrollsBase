...
use Page\Functional\Banks\Index as Page;
use Page\Functional\Banks\Destroy as DestroyPage;
use Page\Functional\Banks\Create as CreatePage;
use Page\Functional\Banks\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->bankId"));
        ...
        $I->amOnPage(Page::route("/$this->bankId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
