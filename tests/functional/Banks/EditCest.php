...
use Page\Functional\Banks\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->amOnPage(Page::route('/'.Page::$bankData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$bankData['id'].'/edit'));
        ...
        $I->seeRecord('banks', null_empty_fields($updateData));
    }
}