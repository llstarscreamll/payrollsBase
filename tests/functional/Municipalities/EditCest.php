...
use Page\Functional\Municipalities\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$municipalityData['id'].'/edit'));
        ...
        $I->seeRecord('municipalities', null_empty_fields($updateData));
    }
}