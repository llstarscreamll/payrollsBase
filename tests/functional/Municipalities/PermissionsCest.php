...
use Page\Functional\Municipalities\Index as Page;
use Page\Functional\Municipalities\Destroy as DestroyPage;
use Page\Functional\Municipalities\Create as CreatePage;
use Page\Functional\Municipalities\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->municipalityId = Page::haveMunicipality($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->municipalityId"));
        ...
        $I->amOnPage(Page::route("/$this->municipalityId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
