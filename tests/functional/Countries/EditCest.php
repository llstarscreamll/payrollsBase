...
use Page\Functional\Countries\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->amOnPage(Page::route('/'.Page::$countryData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$countryData['id'].'/edit'));
        ...
        $I->seeRecord('countries', null_empty_fields($updateData));
    }
}