...
use Page\Functional\ContributorTypes\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveContributorType($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$contributorTypeData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$contributorTypeData['id'].'/edit'));
        ...
        $I->seeRecord('contributor_types', null_empty_fields($updateData));
    }
}