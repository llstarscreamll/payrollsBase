...
namespace LegalCompanyNatures;

use FunctionalTester;
use App\Models\LegalCompanyNature;
use llstarscreamll\Core\Models\Role;
use llstarscreamll\Core\Models\Permission;
use Page\Functional\LegalCompanyNatures\Index as Page;
use Page\Functional\LegalCompanyNatures\Destroy as DestroyPage;
use Page\Functional\LegalCompanyNatures\Create as CreatePage;
use Page\Functional\LegalCompanyNatures\Edit as EditPage;
...
class PermissionsCest
{
     ...
     * @var  int
     */
    protected $legalCompanyNatureId;
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'legal-company-natures.create',
            'legal-company-natures.edit',
            'legal-company-natures.destroy',
        ];
        ...
        $this->legalCompanyNatureId = Page::haveLegalCompanyNature($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->legalCompanyNatureId"));
        ...
        $I->amOnPage(Page::route("/$this->legalCompanyNatureId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
