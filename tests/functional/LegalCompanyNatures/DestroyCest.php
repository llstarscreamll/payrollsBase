...
use Page\Functional\LegalCompanyNatures\Destroy as Page;
...
class DestroyCest
{
    ...
    public function deleteMany(FunctionalTester $I)
    {
        ...
        $legalCompanyNatures = factory(LegalCompanyNature::class, 10)->create();
        ...
        $I->submitForm('#deletemanyForm', [
            'id' => $legalCompanyNatures->pluck('id')->toArray()
        ]);
        $I->dontSeeFormErrors();
