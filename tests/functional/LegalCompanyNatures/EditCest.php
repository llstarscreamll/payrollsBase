...
use Page\Functional\LegalCompanyNatures\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveLegalCompanyNature($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$legalCompanyNatureData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$legalCompanyNatureData['id'].'/edit'));
        ...
        $I->seeRecord('legal_company_natures', null_empty_fields($updateData));
    }
}