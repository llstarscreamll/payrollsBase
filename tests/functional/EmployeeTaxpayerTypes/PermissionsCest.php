...
use Page\Functional\EmployeeTaxpayerTypes\Index as Page;
use Page\Functional\EmployeeTaxpayerTypes\Destroy as DestroyPage;
use Page\Functional\EmployeeTaxpayerTypes\Create as CreatePage;
use Page\Functional\EmployeeTaxpayerTypes\Edit as EditPage;
...
class PermissionsCest
{
     ...
     * @var  int
     */
    protected $employeeTaxpayerTypeId;
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'employee-taxpayer-types.create',
            'employee-taxpayer-types.edit',
            'employee-taxpayer-types.destroy',
        ];
        ...
        $this->employeeTaxpayerTypeId = Page::haveEmployeeTaxpayerType($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->employeeTaxpayerTypeId"));
        ...
        $I->amOnPage(Page::route("/$this->employeeTaxpayerTypeId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
