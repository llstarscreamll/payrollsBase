...
use Page\Functional\EmployeeTaxpayerTypes\Destroy as Page;
...
class DestroyCest
{
    ...
    public function deleteMany(FunctionalTester $I)
    {
        ...
        $employeeTaxpayerTypes = factory(EmployeeTaxpayerType::class, 10)->create();
        ...
        $I->submitForm('#deletemanyForm', [
            'id' => $employeeTaxpayerTypes->pluck('id')->toArray()
        ]);
        $I->dontSeeFormErrors();
