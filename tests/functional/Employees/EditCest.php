...
use Page\Functional\Employees\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->amOnPage(Page::route('/'.Page::$employeeData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$employeeData['id'].'/edit'));
        ...
        $I->seeRecord('employees', null_empty_fields($updateData));
    }
}