...
use Page\Functional\Employees\Index as Page;
use Page\Functional\Employees\Destroy as DestroyPage;
use Page\Functional\Employees\Create as CreatePage;
use Page\Functional\Employees\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->employeeId = Page::haveEmployee($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->employeeId"));
        ...
        $I->amOnPage(Page::route("/$this->employeeId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
