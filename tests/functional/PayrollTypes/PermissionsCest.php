...
namespace PayrollTypes;

use FunctionalTester;
use App\Models\PayrollType;
use llstarscreamll\Core\Models\Role;
use llstarscreamll\Core\Models\Permission;
use Page\Functional\PayrollTypes\Index as Page;
use Page\Functional\PayrollTypes\Destroy as DestroyPage;
use Page\Functional\PayrollTypes\Create as CreatePage;
use Page\Functional\PayrollTypes\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->payrollTypeId = Page::havePayrollType($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->payrollTypeId"));
        ...
        $I->amOnPage(Page::route("/$this->payrollTypeId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
