...
use Page\Functional\PayrollTypes\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::havePayrollType($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$payrollTypeData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$payrollTypeData['id'].'/edit'));
        ...
        $I->seeRecord('payroll_types', null_empty_fields($updateData));
    }
}