...
use Page\Functional\Companies\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->amOnPage(Page::route('/'.Page::$companyData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$companyData['id'].'/edit'));
        ...
        $I->seeRecord('companies', null_empty_fields($updateData));
    }
}