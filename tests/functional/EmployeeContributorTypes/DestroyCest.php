...
use Page\Functional\EmployeeContributorTypes\Destroy as Page;
...
class DestroyCest
{
    ...
    public function deleteMany(FunctionalTester $I)
    {
        ...
        $employeeContributorTypes = factory(EmployeeContributorType::class, 10)->create();
        ...
        $I->submitForm('#deletemanyForm', [
            'id' => $employeeContributorTypes->pluck('id')->toArray()
        ]);
        $I->dontSeeFormErrors();
