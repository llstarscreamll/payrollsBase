...
use Page\Functional\EmployeeContributorTypes\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveEmployeeContributorType($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$employeeContributorTypeData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$employeeContributorTypeData['id'].'/edit'));
        ...
        $I->seeRecord('employee_contributor_types', null_empty_fields($updateData));
    }
}