...
namespace EmployeeContributorTypes;

use FunctionalTester;
use App\Models\EmployeeContributorType;
use llstarscreamll\Core\Models\Role;
use llstarscreamll\Core\Models\Permission;
use Page\Functional\EmployeeContributorTypes\Index as Page;
use Page\Functional\EmployeeContributorTypes\Destroy as DestroyPage;
use Page\Functional\EmployeeContributorTypes\Create as CreatePage;
use Page\Functional\EmployeeContributorTypes\Edit as EditPage;
...
class PermissionsCest
{
     ...
     * @var  int
     */
    protected $employeeContributorTypeId;
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'employee-contributor-types.create',
            'employee-contributor-types.edit',
            'employee-contributor-types.destroy',
        ];
        ...
        $this->employeeContributorTypeId = Page::haveEmployeeContributorType($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->employeeContributorTypeId"));
        ...
        $I->amOnPage(Page::route("/$this->employeeContributorTypeId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
