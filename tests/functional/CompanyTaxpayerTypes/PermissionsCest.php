...
namespace CompanyTaxpayerTypes;

use FunctionalTester;
use App\Models\CompanyTaxpayerType;
use llstarscreamll\Core\Models\Role;
use llstarscreamll\Core\Models\Permission;
use Page\Functional\CompanyTaxpayerTypes\Index as Page;
use Page\Functional\CompanyTaxpayerTypes\Destroy as DestroyPage;
use Page\Functional\CompanyTaxpayerTypes\Create as CreatePage;
use Page\Functional\CompanyTaxpayerTypes\Edit as EditPage;
...
class PermissionsCest
{
     ...
     * @var  int
     */
    protected $companyTaxpayerTypeId;
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $permissions = [
            'company-taxpayer-types.create',
            'company-taxpayer-types.edit',
            'company-taxpayer-types.destroy',
        ];
        ...
        $this->companyTaxpayerTypeId = Page::haveCompanyTaxpayerType($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->companyTaxpayerTypeId"));
        ...
        $I->amOnPage(Page::route("/$this->companyTaxpayerTypeId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
