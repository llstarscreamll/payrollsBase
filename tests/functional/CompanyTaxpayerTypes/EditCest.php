...
use Page\Functional\CompanyTaxpayerTypes\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        Page::haveCompanyTaxpayerType($I);

        // voy a la página de detalles del registro
        $I->amOnPage(Page::route('/'.Page::$companyTaxpayerTypeData['id']));
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$companyTaxpayerTypeData['id'].'/edit'));
        ...
        $I->seeRecord('company_taxpayer_types', null_empty_fields($updateData));
    }
}