...
use Page\Functional\CompanyTaxpayerTypes\Destroy as Page;
...
class DestroyCest
{
    ...
    public function deleteMany(FunctionalTester $I)
    {
        ...
        $companyTaxpayerTypes = factory(CompanyTaxpayerType::class, 10)->create();
        ...
        $I->submitForm('#deletemanyForm', [
            'id' => $companyTaxpayerTypes->pluck('id')->toArray()
        ]);
        $I->dontSeeFormErrors();
