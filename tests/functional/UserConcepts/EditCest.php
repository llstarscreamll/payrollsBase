...
use Page\Functional\UserConcepts\Edit as Page;
...
class EditCest
{
    ...
    public function edit(FunctionalTester $I)
    {
        ...
        $I->seeCurrentUrlEquals(Page::route('/'.Page::$userConceptData['id'].'/edit'));
        ...
        $I->seeRecord('user_concepts', null_empty_fields($updateData));
    }
}