...
use Page\Functional\UserConcepts\Index as Page;
use Page\Functional\UserConcepts\Destroy as DestroyPage;
use Page\Functional\UserConcepts\Create as CreatePage;
use Page\Functional\UserConcepts\Edit as EditPage;
...
class PermissionsCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->userConceptId = Page::haveUserConcept($I);
    }
    ...
    public function editPermissions(FunctionalTester $I)
    {
        ...
        // edición
        $I->amOnPage(Page::route("/$this->userConceptId"));
        ...
        $I->amOnPage(Page::route("/$this->userConceptId/edit"));
        $I->seeCurrentUrlEquals(Page::$homeUrl);
        $I->see(Page::$badPermissionsMsg, Page::$badPermissionsMsgElem);
    }
