...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/pila-payment-operators';
     ...
     * @var  string
     */
    public static $moduleName = 'Operadores de pago PILA';
     ...
     * @var  array
     */
    public static $pilaPaymentOperatorData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'PilaPaymentOperatorPermissionsSeeder']);
        ...
        static::$pilaPaymentOperatorData = [
            'id' => 1,
            'name' => 'Aportes en línea',
            'short_name' => 'AEL',
            'phone' => '123456',
            'email' => 'aportes@aportes.com',
            'website' => 'foo.com',
        ];
    }
     ...
     */
    public static function havePilaPaymentOperator(FunctionalTester $I)
    {
        return $I->haveRecord('pila_payment_operators', static::$pilaPaymentOperatorData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$pilaPaymentOperatorData as $key => $value) {
    ...
    {
        $data = static::$pilaPaymentOperatorData;
    ...
    {
        $data = !empty($data) ? $data : static::$pilaPaymentOperatorData;
