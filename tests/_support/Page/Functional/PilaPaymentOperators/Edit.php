...
class Edit extends Index
{
     ...
     * @var  string
     */
    public static $form = 'form[name=edit-pila-payment-operators-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Operador de pago PILA actualizado correctamente.';
    ...
    public static function getDataToUpdateForm()
    {
        ...
        $data = [
            ...
            'short_name' => 'COM',
            'phone' => '654321',
            'email' => 'compensar@compensar.com',
            'website' => 'compensar.com',
        ];
