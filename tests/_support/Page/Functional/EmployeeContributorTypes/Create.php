...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/employee-contributor-types/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Tipo de empleado aportante';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-employee-contributor-types-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Tipo de empleado aportante creado correctamente.';
