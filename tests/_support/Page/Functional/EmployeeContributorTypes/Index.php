...
namespace Page\Functional\EmployeeContributorTypes;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/employee-contributor-types';
     ...
     * @var  string
     */
    public static $moduleName = 'Tipos de empleado aportante';
     ...
     * @var  array
     */
    public static $employeeContributorTypeData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'EmployeeContributorTypePermissionsSeeder']);
        ...
        static::$employeeContributorTypeData = [
            'id' => 1,
            'name' => 'Foo',
            'short_name' => 'Bar',
        ];
     ...
     */
    public static function haveEmployeeContributorType(FunctionalTester $I)
    {
        return $I->haveRecord('employee_contributor_types', static::$employeeContributorTypeData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$employeeContributorTypeData as $key => $value) {
    ...
    {
        $data = static::$employeeContributorTypeData;
    ...
    {
        $data = !empty($data) ? $data : static::$employeeContributorTypeData;
