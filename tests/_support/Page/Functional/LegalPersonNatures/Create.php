...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/legal-person-natures/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Tipo de Persona';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-legal-person-natures-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Tipo de Persona creado correctamente.';
