...
namespace Page\Functional\LegalPersonNatures;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/legal-person-natures';
     ...
     * @var  string
     */
    public static $moduleName = 'Tipos de Personas';
     ...
     * @var  array
     */
    public static $legalPersonNatureData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'LegalPersonNaturePermissionsSeeder']);
     ...
     */
    public static function haveLegalPersonNature(FunctionalTester $I)
    {
        return $I->haveRecord('legal_person_natures', static::$legalPersonNatureData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$legalPersonNatureData as $key => $value) {
    ...
    {
        $data = static::$legalPersonNatureData;
    ...
    {
        $data = !empty($data) ? $data : static::$legalPersonNatureData;
