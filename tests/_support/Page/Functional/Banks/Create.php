...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/banks/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Banco';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-banks-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Banco creado correctamente.';
