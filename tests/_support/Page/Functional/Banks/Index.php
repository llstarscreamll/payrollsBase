...
namespace Page\Functional\Banks;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleName = 'Bancos';
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'BankPermissionsSeeder']);
     ...
     */
    public static function haveBank(FunctionalTester $I)
    {
        return $I->haveRecord('banks', static::$bankData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$bankData as $key => $value) {
    ...
    {
        $data = !empty($data) ? $data : static::$bankData;
