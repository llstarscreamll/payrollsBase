...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/user-concepts/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Concepto';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-user-concepts-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Concepto creado correctamente.';
