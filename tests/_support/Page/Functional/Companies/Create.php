...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/companies/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Empresa';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-companies-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Empresa creado correctamente.';
