...
namespace Page\Functional\EmployeeTaxpayerTypes;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/employee-taxpayer-types';
     ...
     * @var  string
     */
    public static $moduleName = 'Tipos de Cotizante';
     ...
     * @var  array
     */
    public static $employeeTaxpayerTypeData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'EmployeeTaxpayerTypePermissionsSeeder']);
        ...
        static::$employeeTaxpayerTypeData = [
            'id' => 1,
     ...
     */
    public static function haveEmployeeTaxpayerType(FunctionalTester $I)
    {
        return $I->haveRecord('employee_taxpayer_types', static::$employeeTaxpayerTypeData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$employeeTaxpayerTypeData as $key => $value) {
    ...
    {
        $data = static::$employeeTaxpayerTypeData;
    ...
    {
        $data = !empty($data) ? $data : static::$employeeTaxpayerTypeData;
