...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/employee-taxpayer-types/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Tipo de Cotizante';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-employee-taxpayer-types-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Tipo de Cotizante creado correctamente.';
