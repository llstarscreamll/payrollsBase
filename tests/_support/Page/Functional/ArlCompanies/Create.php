...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/arl-companies/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Compañía de ARL';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-arl-companies-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Compañía de ARL creado correctamente.';
