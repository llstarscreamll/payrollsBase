...
namespace Page\Functional\ArlCompanies;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/arl-companies';
     ...
     * @var  string
     */
    public static $moduleName = 'Compañías de ARL';
     ...
     * @var  array
     */
    public static $arlCompanyData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'ArlCompanyPermissionsSeeder']);
     ...
     */
    public static function haveArlCompany(FunctionalTester $I)
    {
        return $I->haveRecord('arl_companies', static::$arlCompanyData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$arlCompanyData as $key => $value) {
    ...
    {
        $data = !empty($data) ? $data : static::$arlCompanyData;
