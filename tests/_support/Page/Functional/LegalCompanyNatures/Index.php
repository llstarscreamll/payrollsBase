...
namespace Page\Functional\LegalCompanyNatures;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/legal-company-natures';
     ...
     * @var  string
     */
    public static $moduleName = 'Naturalezas Jurídicas';
     ...
     * @var  array
     */
    public static $legalCompanyNatureData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'LegalCompanyNaturePermissionsSeeder']);
     ...
     */
    public static function haveLegalCompanyNature(FunctionalTester $I)
    {
        return $I->haveRecord('legal_company_natures', static::$legalCompanyNatureData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$legalCompanyNatureData as $key => $value) {
    ...
    {
        $data = static::$legalCompanyNatureData;
    ...
    {
        $data = !empty($data) ? $data : static::$legalCompanyNatureData;
