...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/legal-company-natures/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Naturaleza Jurídica';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-legal-company-natures-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Naturaleza Jurídica creado correctamente.';
