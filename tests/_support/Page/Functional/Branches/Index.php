...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/branches';
     ...
     * @var  array
     */
    public static $branchData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'BranchPermissionsSeeder']);
     ...
     */
    public static function haveBranch(FunctionalTester $I)
    {
        return $I->haveRecord('branches', static::$branchData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$branchData as $key => $value) {
    ...
    {
        $data = !empty($data) ? $data : static::$branchData;
