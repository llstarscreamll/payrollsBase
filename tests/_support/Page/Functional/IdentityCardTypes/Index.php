...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/identity-card-types';
     ...
     * @var  string
     */
    public static $moduleName = 'Tipos de Documento de Identificación';
     ...
     * @var  array
     */
    public static $identityCardTypeData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'IdentityCardTypePermissionsSeeder']);
     ...
     */
    public static function haveIdentityCardType(FunctionalTester $I)
    {
        return $I->haveRecord('identity_card_types', static::$identityCardTypeData);
    }
    ...
    {
        $data = static::$identityCardTypeData;
    ...
    {
        $data = !empty($data) ? $data : static::$identityCardTypeData;
