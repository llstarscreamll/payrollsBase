...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/identity-card-types/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Tipo de Documento de Identificación';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-identity-card-types-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Tipo de Documento de Identificación creado correctamente.';
