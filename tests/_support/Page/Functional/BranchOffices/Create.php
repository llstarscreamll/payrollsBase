...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/branch-offices/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Sucursal';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-branch-offices-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Sucursal creado correctamente.';
