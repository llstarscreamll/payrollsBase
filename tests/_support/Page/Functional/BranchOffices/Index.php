...
namespace Page\Functional\BranchOffices;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/branch-offices';
     ...
     * @var  string
     */
    public static $moduleName = 'Sucursales';
     ...
     * @var  array
     */
    public static $branchOfficeData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'BranchOfficePermissionsSeeder']);
        ...
        static::$branchOfficeData = [
            'id' => 1,
            'company_id' => Company::first(['id'])->id,
            'name' => 'Sucursal Uno',
        ];
    }
     ...
     */
    public static function haveBranchOffice(FunctionalTester $I)
    {
        return $I->haveRecord('branch_offices', static::$branchOfficeData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$branchOfficeData as $key => $value) {
    ...
    {
        $data = static::$branchOfficeData;

        // los datos de las llaves foráneas
        $data['company_id'] = Company::find($data['company_id'])->name;
    ...
    {
        $data = !empty($data) ? $data : static::$branchOfficeData;
