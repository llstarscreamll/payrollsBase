...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/countries';
     ...
     * @var  string
     */
    public static $moduleName = 'Paises';
     ...
     * @var  array
     */
    public static $countryData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'CountryPermissionsSeeder']);
     ...
     */
    public static function haveCountry(FunctionalTester $I)
    {
        return $I->haveRecord('countries', static::$countryData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$countryData as $key => $value) {
    ...
    {
        $data = !empty($data) ? $data : static::$countryData;
