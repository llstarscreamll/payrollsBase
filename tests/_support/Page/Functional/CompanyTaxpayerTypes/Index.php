...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/company-taxpayer-types';
     ...
     * @var  string
     */
    public static $moduleName = 'Tipos de Aportantes';
     ...
     * @var  array
     */
    public static $companyTaxpayerTypeData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'CompanyTaxpayerTypePermissionsSeeder']);
        ...
        static::$companyTaxpayerTypeData = [
            'id' => 1,
            'name' => 'Más de 200 cotizantes',
            'short_name' => 'A',
     ...
     */
    public static function haveCompanyTaxpayerType(FunctionalTester $I)
    {
        return $I->haveRecord('company_taxpayer_types', static::$companyTaxpayerTypeData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$companyTaxpayerTypeData as $key => $value) {
    ...
    {
        $data = static::$companyTaxpayerTypeData;
    ...
    {
        $data = !empty($data) ? $data : static::$companyTaxpayerTypeData;
