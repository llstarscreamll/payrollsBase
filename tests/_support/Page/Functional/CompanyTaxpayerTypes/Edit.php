...
class Edit extends Index
{
     ...
     * @var  string
     */
    public static $form = 'form[name=edit-company-taxpayer-types-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Tipo de Aportante actualizado correctamente.';
