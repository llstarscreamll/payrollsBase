...
class Edit extends Index
{
     ...
     * @var  string
     */
    public static $form = 'form[name=edit-municipalities-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Municipio actualizado correctamente.';
    ...
    public static function getDataToUpdateForm()
    {
        ...
        $data = [
            'department_id' => Department::all(['id'])->last()->id,
            'code' => 123,
            'name' => 'Tunja',
        ];
