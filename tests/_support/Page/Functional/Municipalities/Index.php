...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/municipalities';
     ...
     * @var  string
     */
    public static $moduleName = 'Municipios';
     ...
     * @var  array
     */
    public static $municipalityData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'MunicipalityPermissionsSeeder']);
        ...
        static::$municipalityData = [
            'id' => 1,
            'department_id' => Department::first(['id'])->id,
            'code' => 111,
            'name' => 'Sogamoso',
        ];
    }
     ...
     */
    public static function haveMunicipality(FunctionalTester $I)
    {
        return $I->haveRecord('municipalities', static::$municipalityData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$municipalityData as $key => $value) {
    ...
    {
        $data = !empty($data) ? $data : static::$municipalityData;
