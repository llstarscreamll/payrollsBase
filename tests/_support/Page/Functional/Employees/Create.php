...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/employees/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Empleado';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-employees-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Empleado creado correctamente.';
