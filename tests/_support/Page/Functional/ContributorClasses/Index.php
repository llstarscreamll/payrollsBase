...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/contributor-classes';
     ...
     * @var  string
     */
    public static $moduleName = 'Clases de aportante';
     ...
     * @var  array
     */
    public static $contributorClassData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'ContributorClassPermissionsSeeder']);
     ...
     */
    public static function haveContributorClass(FunctionalTester $I)
    {
        return $I->haveRecord('contributor_classes', static::$contributorClassData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$contributorClassData as $key => $value) {
    ...
    {
        $data = static::$contributorClassData;
    ...
    {
        $data = !empty($data) ? $data : static::$contributorClassData;
