...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/contributor-classes/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Clase de aportante';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-contributor-classes-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Clase de aportante creado correctamente.';
