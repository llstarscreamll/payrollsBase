...
class Create extends Index
{
     ...
     * @var  string
     */
    public static $URL = '/payroll-types/create';
     ...
     * @var  string
     */
    public static $createBtn = 'Crear Tipo de planilla';
     ...
     * @var  string
     */
    public static $form = 'form[name=create-payroll-types-form]';
     ...
     * @var  array
     */
    public static $msgSuccess = 'Tipo de planilla creado correctamente.';
