...
namespace Page\Functional\PayrollTypes;
...
class Index{
     ...
     * @var  string
     */
    public static $moduleURL = '/payroll-types';
     ...
     * @var  string
     */
    public static $moduleName = 'Tipos de planilla';
     ...
     * @var  array
     */
    public static $payrollTypeData = array();
    ...
    public function __construct(FunctionalTester $I)
    {
        ...
        \Artisan::call('db:seed', ['--class' => 'PayrollTypePermissionsSeeder']);
     ...
     */
    public static function havePayrollType(FunctionalTester $I)
    {
        return $I->haveRecord('payroll_types', static::$payrollTypeData);
    }
    ...
    public static function getCreateData()
    {
        ...
        foreach (static::$payrollTypeData as $key => $value) {
    ...
    {
        $data = !empty($data) ? $data : static::$payrollTypeData;
